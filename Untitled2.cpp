...
int main()
{
	...
	while(true){
		cout<<"1.Student Information"<<endl<<"2.Marks"<<endl<<"3.Rank"<<endl<<"4.Attendence"<<endl<<"5.EXIT"<<endl;
		cin>>command;
		if(command==5)
		break;
		else if(command==1)
		{
			while(true){
			cout<<"1.Search Student"<<endl<<"2.Enter Student Information"<<endl<<"3.Students Need Focus"<<endl<<"4.Exit"<<endl;
			cin>>command;
			if(command==4)
			break;
			else if(command==1){
		...
		{
			while(true){
				cout<<"1.E1806"<<endl<<"2.E1808"<<endl<<"3.Exit"<<endl;
				cin>>command;
				if(command==3)
				break;
				else if(command==1){
						while(true){
						cout<<"1.View Class Attendence List"<<endl<<"2.Take Attendence"<<endl<<"3.Exit"<<endl;
						cin>>command;
						if(command==3)
						break;
			            else if(command==1)
